...
def main():
    ...
    with torch.inference_mode():
        ...
        loraloader_10 = loraloader.load_lora(
            lora_name="EasterEggHome_IXL.safetensors",
            strength_model=1,
            strength_clip=1,
        ...
        clipsetlastlayer_11 = clipsetlastlayer.set_last_layer(
        ...
        cliptextencode_6 = cliptextencode.encode(
            text="sculptures, beautiful scenery, nature, glass Santa Claus , landscape, , purple glass Santa,",
            clip=get_value_at_index(clipsetlastlayer_11, 0),
        )

        cliptextencode_7 = cliptextencode.encode(
            text="text, watermark", clip=get_value_at_index(clipsetlastlayer_11, 0)
        )
